...
== Example
 ...
 # for the list of request and response parameters.
 cj.commissions('date-type' => 'event').each do |commission|
...
* Commit. Do not mess with Rakefile or history (if you want to have your own version, that is fine but bump version in a commit by itself I can ignore when I pull).
